...
if(isset($_SESSION['username']) && isset($_SESSION['level']))
{
  ...
  if(isset($_POST['save']))
  {
    ...
    $salary = $_POST['salary'];
    $note = $_POST['note'];  // Ghi chú bình thường
    ...
    {
      $showMess = true;
      $insert = "INSERT INTO chuc_vu(ma_chuc_vu, ten_chuc_vu, luong_ngay, ghi_chu, nguoi_tao, ngay_tao, nguoi_sua, ngay_sua) VALUES('$positionCode','$titlePosition', '$salary', '$note', '$personCreate', '$dateCreate', '$personEdit', '$dateEdit')";
              ...
              <form action="" method="POST">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ghi chú: </label> <!-- Ghi chú bình thường -->
                      <textarea class="form-control" rows="5" name="note" placeholder="Nhập ghi chú"></textarea>
                    </div>
                    <div class="form-group">
              ...
              <div class="table-responsive">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <th>Tên chức vụ</th>
                    <th>Lương ngày</th>
                    <th>Ghi chú</th> <!-- Ghi chú bình thường -->
                    <th>Người tạo</th>
                    <th>Ngày tạo</th>
                    <th>Người sửa</th>
                    <th>Ngày sửa</th>
