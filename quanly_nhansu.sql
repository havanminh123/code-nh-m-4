...
--
-- Host: localhost:3306
-- Generation Time: Aug 02, 2024 at 09:21 AM
...
CREATE TABLE `chinh_luong` (
  ...
  `so_qd` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `cong_tac` (
  `id` int NOT NULL,
  `ma_cong_tac` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `nhanvien_id` int NOT NULL,
  `ngay_bat_dau` date NOT NULL,
  `ngay_ket_thuc` date NOT NULL,
  `dia_diem` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `muc_dich` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ghi_chu` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
...
CREATE TABLE `khen_thuong_ky_luat` (
  `id` int NOT NULL,
  `ma_kt` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `so_qd` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ngay_qd` date NOT NULL,
  `nhanvien_id` int NOT NULL,
  `ten_khen_thuong` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `loai_kt_id` int NOT NULL,
...
(12, 'MKL1722589177', '556asd', '2024-08-02', 14, 'kỷ luật', 14, 1, 500000, 0, '<p>kỷ luật</p>\r\n', 'Account Admin', '2024-08-02 15:59:37', 'Account Admin', '2024-08-02 15:59:37');
...
CREATE TABLE `loai_khen_thuong_ky_luat` (
  `id` int NOT NULL,
  `ma_loai` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ten_loai` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ghi_chu` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `flag` tinyint(1) NOT NULL,
  `nguoi_tao` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `ngay_tao` datetime NOT NULL,
...
CREATE TABLE `luong` (
  `id` int NOT NULL,
  `ma_luong` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL,
  `nhanvien_id` int NOT NULL,
...
(14, 'MNV1722588988', 'demo-3x4.jpg', 'Nguyễn Văn A', 'AZZ', 1, '2000-08-02', 'Hà Nội', 1, '0336216546', 'Hà Nội', '2020-01-02', 'Hà Nội', 34, 0, 1, 'Hà Nội', 'Hà Nội', 2, 17, 2, 1, 21, 33, 1, 1, '2024-08-02 15:56:28', 1, '2024-08-02 15:56:28');
...
(1, 'trị viên', 'Quản', 'admin.png', 'admin@gmail.com', 'a66abb5684c45962d887564f08346e8d', '0336216546', 1, 1, 47, '2019-09-12 00:00:00', '2024-08-02 15:51:48'),
(2, 'Thái', 'Mỹ Tiên', '1568644813.jpg', 'ruakundor@gmail.com', 'a66abb5684c45962d887564f08346e8d', '099999999999', 0, 1, 21, '2019-09-16 21:15:00', '2019-09-20 18:07:30'),
...
(13, 'Nguyễn', 'Khoa', 'admin.png', 'nguyenleanhkhoa.dev@gmail.com', '202cb962ac59075b964b07152d234b70', '0336216555', 1, 1, 0, '2024-08-02 15:52:27', '2024-08-02 16:20:20');
